    ...
    <section className="portfolio">
      <div className="portfolio__content">
        ...
        <ul className="portfolio__list">
          <li className="portfolio__item"><a href="https://github.com/Lusabero/how-to-learn/" className="portfolio__link"
          ...
          <li className="portfolio__item"><a href="https://lusabero.github.io/russian-travel/" className="portfolio__link"
                                             target="_blank" rel="noreferrer"><p className="portfolio__link-name">Адаптивный сайт</p><img
            src={Arrow} className="portfolio__arrow" alt="Стрелка"/></a></li>
          <li className="portfolio__item"><a href="https://mesto.lusabero.nomoredomains.xyz/" className="portfolio__link"
